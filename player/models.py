...
class Player(models.Model):
    ...
    def level_up(self):
        ...
        experiencia_necessaria = self.getExperiencias()
    ...
    def getExperiencias(self):
        return {2: 20, 3: 30, 4: 50, 5: 80, 6: 130, 
                                  7: 210, 8: 340, 9: 480, 10: 630,
...
# sender=User, ou seja, quem originou o sinal foi um User
#O sinal post_save eh emitido tanto quando o objeto eh criado quanto quando eh modificado
models.signals.post_save.connect(cria_user_player, sender=User) 